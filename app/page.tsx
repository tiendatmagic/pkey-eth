...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen ${bgMain} ${textMain} font-sans flex flex-col items-center pt-8 pb-32 transition-colors duration-300 relative`}>
      ...
      <div className="max-w-7xl w-full px-4">
        <div className="text-center mb-10 pt-4 flex flex-col items-center">
          <div className="mb-4 bg-slate-800/20 p-3 rounded-2xl border border-slate-700/30 backdrop-blur-sm">
          ...
          <div className={`mt-8 ${cardBg} rounded-2xl ${isDark ? "shadow-[0_0_40px_rgba(16,185,129,0.15)]" : "shadow-xl border-emerald-300"} p-6 md:p-8 border ${isDark ? "border-emerald-500/50" : "border-emerald-400"} backdrop-blur-sm animate-[fadeIn_0.5s_ease-out] transition-colors duration-300`}>
            ...
            <div className="mt-6 flex flex-col items-center">
              <button
                ...
                className={`flex items-center gap-2 mb-4 px-5 py-2.5 rounded-lg border-2 ${isDark ? 'border-indigo-500/50 hover:bg-indigo-500/20 text-indigo-300' : 'border-indigo-400 hover:bg-indigo-50 text-indigo-700'} font-bold transition-all shadow-sm transform hover:-translate-y-0.5 group`}
              >
              ...
              <p className={`text-amber-500/90 text-sm font-semibold`}>{t.securityWarning}</p>
            </div>
          </div>
        )}
